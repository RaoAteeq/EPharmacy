...
public class ModelShop {
    private String uid,email,name,shopName,phone,deliveryFee,country,state,city,address,latitude,longitude,
            timestamp,accountType,online,shopOpen,profileImage;
